  ...
  return (
    <div className='relative'>
      <div className='flex items-center justify-center p-2 bg-gray-200 rounded-md'>
        ...
        <button className='bg-blue-400/20 py-2 px-4 border border-gray-400 rounded-md text-gray-800 hover:bg-gray-200' onClick={handleOpenModal}>What's on your mind?</button>
      </div>
      {showModal && (
        <div className='fixed top-0 left-0 w-full h-full flex items-center bg-black bg-opacity-60 z-50'>  
          <div className='max-w-lg mx-auto p-4 bg-white rounded-md shadow-xl'>
            <div className='flex justify-between'>
              ...
              <button className='text-gray-800 font-medium' onClick={handleCloseModal}>X</button>
            </div>
            <form className='mt-6'>
